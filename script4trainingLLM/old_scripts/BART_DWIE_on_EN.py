...
train_file = 'generated_dataset/short_Instances/DWIE_train.json'
dev_file = 'generated_dataset/short_Instances/DWIE_validation.json'
test_file = 'generated_dataset/short_Instances/DWIE_test.json'
...
tokenize_data = dataset.map(preprocess_data, batched = True, remove_columns=['story', 'Instances Knowledge Graph'])
# print(tokenize_data)
...
trainer.save_model("finetuned_BART_vanillaDWIE_on_EN")
...
outfile = open('metrics_BART_vanillaDWIE_EN.txt', "a", encoding='utf-8')
...
outfile1 = open('stories_BART_vanillaDWIE_EN.txt', "a", encoding='utf-8')
