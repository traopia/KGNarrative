...
def create_dict_file(tree,verbose=False):
    ...
    for entry in tree.findall('.//entry'):
        ...
        if verbose==True:
            ...
            print(f'{entities=}')
        classes = [get_entity_class('http://dbpedia.org/resource/'+entity) for entity in entities if ('"' not in entity) or ('http' not in entity) or ('@' not in entity) or (',' not in entity) or ('xsd' not in entity)]
